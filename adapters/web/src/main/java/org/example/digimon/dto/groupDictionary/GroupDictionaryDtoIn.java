...
public class GroupDictionaryDtoIn implements Serializable {
    ...
    public GroupDictionaryDtoIn(Long id, String value, Date updatedAt, String updatedBy, Set<DigimonDtoIn> digimons) {
        this.id = id;
        this.value = value;
    ...
    public boolean equals(Object o) {
        ...
        GroupDictionaryDtoIn entity = (GroupDictionaryDtoIn) o;
