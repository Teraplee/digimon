...
public class GroupDictionaryDtoOut implements Serializable {
    ...
    public GroupDictionaryDtoOut(Long id, String value, Date updatedAt, String updatedBy, Set<DigimonDtoOut> digimons) {
        this.id = id;
        this.value = value;
    ...
    public boolean equals(Object o) {
        ...
        GroupDictionaryDtoOut entity = (GroupDictionaryDtoOut) o;
