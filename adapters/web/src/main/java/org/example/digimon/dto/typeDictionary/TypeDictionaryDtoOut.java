...
public class TypeDictionaryDtoOut implements Serializable {
    ...
    public TypeDictionaryDtoOut(Long id, String value, Date updatedAt, String updatedBy, Set<DigimonDtoOut> digimons) {
        this.id = id;
        this.value = value;
    ...
    public boolean equals(Object o) {
        ...
        TypeDictionaryDtoOut entity = (TypeDictionaryDtoOut) o;
